...
import com.example.website_ban_ao_the_thao_psg_du_an_tot_nghiep.model.mapper.NhanVienMapper;
...
import com.example.website_ban_ao_the_thao_psg_du_an_tot_nghiep.repository.NhanVienRepository;
...
public class NhanVienServiceImpl implements NhanVienService {
    ...
    public NhanVienResponse create(CreateNhanVienRequest createNhanVienRequest) {
        try {
            ...
            throw new InternalServerException("Failed to create nhan vien due to an unexpected error." + ex);
        }
    }
    ...
    public NhanVienResponse update(UpdateNhanVienRequest updateNhanVienRequest, Integer id) {
        try {
            ...
            throw new InternalServerException("Failed to update nhan vien due to an unexpected error." + ex);
        }
    }
    ...
    @Override
    public void sendForgotPasswordEmailForNhanVien(String email, String soCanCuocCongDan) {
        NhanVien nhanVien = nhanVienRepository.findByEmail(email);
        if (nhanVien != null && nhanVien.getSoCanCuocCongDan().equals(soCanCuocCongDan)) {
